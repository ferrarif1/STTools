...
var SEQUENCE = Date.now(), noop = function() {}, getCwarn = function() {
...
}, util_1 = util, pushToQueue = function(e, t) {
    var i;
    {
    ...
    return this.ver = "1.2.2", this.syn = 0, this.err = 0, this._conf = util.ext({}, Base.dftCon), 
    this.sampleCache = {}, this.requestQueue = [], this.hash = util.seq(), this.resetSession(), 
    this.setConfig(t), this.rip = util.getRandIP(), this._common = {}, this;
};
...
Base.dftCon = {
    ...
    custom: function(e, t) {
        ...
        return util.each(e, function(e, t) {
            return !(i = t && t.length <= 20) && util.warn("[CloudMonitor] invalid key: " + t), 
            r["x-" + t] = e, i;
...
var base = Base, validApiKeys = [ "api", "success", "time", "code", "msg", "begin", "response", "c1", "c2", "c3" ], parseStatData = function(t, e) {
    var r = t.split("::");
...
Reporter.prototype = util_1.createObject(base.prototype), util_1.ext(base.dftCon, {
    ...
    error: function(t, e) {
        ...
        var r = t.name || "CustomError", n = util_1.encode(t.message), i = util_1.encode(util_1.replaceAll(t.stack || "", "http.*\\d*:\\d*", "unknow"));
        e = e || {};
        var s = {
            begin: Date.now(),
            cate: r,
    ...
    api: function(e, t, r, i, a, s) {
        ...
        e.begin = e.begin || "", !e.api || isNaN(e.time)) {
    ...
    resource: function(t, e) {
        ...
        var r = Object.keys(t), n = [ "begin", "dom", "load", "res", "dl" ], i = !1;
        for (var o in n) {
            if (r.indexOf(n[o]) < 0) {
                i = !0;
                break;
...
var reporter = Reporter, MiniProgramLogger = function(t) {
    var o = this;
...
MiniProgramLogger.prototype = util.createObject(Reporter.prototype), util.ext(Reporter._root.dftCon, {
    ...
    _lgPV: function(t) {
        ...
        !t.spmPre && (t.spmPre = util.toHex(this.getPage()) || ""), !t.spmId && (t.spmId = util.toHex(t.page) || ""), 
        !t.scene && (t.scene = ""), this._lg("pv", t);
    },
    ...
    parseResponse: function(e) {
        ...
        var r = "", c = util.getPropertyValue(e, this._conf.code) || e.stat || e.status || e.code || e.success, u = util.getPropertyValue(e, this._conf.msg) || e.msg || e.message || e.subMsg || e.errorMsg || e.ret || e.errorResponse || "";
        "object" == typeof u && (c = c || u.code, u = u.msg || u.message || u.info || u.ret || JSON.stringify(u));
        return {
            code: c,
            msg: u,
            response: util.pick(1e4) ? JSON.stringify(e).substr(0, 256) : ""
        };
    }
});
...
var miniProgramLogger = MiniProgramLogger, STORAGE_MINIPROGRAM_ALIPAY_UID_KEY = "STORAGE_MINIPROGRAM_ALIPAY_UID", AlipayLogger = function(t) {
...
AlipayLogger.prototype = util.createObject(MiniProgramLogger.prototype), util.ext(MiniProgramLogger._root.dftCon, {
    ...
    getPrePage: function(delta) {
        if ("function" == typeof getCurrentPages) {
            try {
                var t = getCurrentPages() || [], e = delta === undefined ? t[t.length - 2] : delta >= t.length ? t[0] : t[t.length - 1 - delta];
                return e && e.route || null;
            } catch (o) {
                o = VM2_INTERNAL_STATE_DO_NOT_USE_OR_PROGRAM_WILL_FAIL.handleException(o);
                util.warn("[cloudMonitor] error in conf getCurrentPage", o);
    ...
    addHook: function() {
        var e = this, t = util, ca = e._conf.autoReportApi, cp = e._conf.autoReportPage;
                ...
                if ("undefined" != typeof my && my && "function" == typeof my.request) {
                    ...
                    a && a.writable && (my.request = function(i) {
                        ...
                        if (i && i.url) {
                            ...
                            var u = n && n.headers, f = e._conf.extendApi;
                            u && "object" == typeof u || (u = {});
                            var p = {
                                success: function(t) {
                                ...
                                fail: function(t) {
                                    ...
                                    n == "" && t.error && (n = t.error);
                                    var u = "", r = f ? util.safetyCall(f, [ i.data ], {}) : {};
...
AlipayLogger._super = miniProgramLogger, AlipayLogger._root = miniProgramLogger._root, 
miniProgramLogger.AlipayLogger = AlipayLogger;
